...
const DAYS = [
  {date:'Sat 27 Mar', city:'madrid', title:'Arrival + soft landing', breakfast:'No', morning:'Flight arrival ~4:25pm from Melbourne. Check in, freshen up.', lunch:'Light bite near apartment', afternoon:'Walk to Templo de Debod for sunset — easy golden-hour viewpoint. Continue past Royal Palace exterior and Plaza de Oriente.', dinner:'La Latina tapas or Mercado de San Miguel for first-night grazing', cocktail:'Ginkgo Sky Bar or Riu 360 near Plaza de España for city views', travelTime:'Taxi airport → Gran Vía approx €30–40', walkingRoute:'Short', estCost:'$150', booking:'Airport transfer recommended', photoSpots:'Templo de Debod at sunset, Gran Vía at dusk', notes:'Madrid eats late — dinner from 9pm. Keep it easy tonight.'},
  {date:'Sun 28 Mar', city:'madrid', title:'Classic Madrid — markets, La Latina, rooftop', breakfast:'No', morning:'Toma Café or HanSo Café for coffee first. 10:00am: Eco Tuk Tuk Express City Tour (1 hour, booked — 2 adults, A$130.38). Great way to orientate around the main sights. After the tour: Puerta del Sol → Plaza Mayor → Mercado de San Miguel (photos + snack). Optional: Royal Palace (book ahead, €24pp).', lunch:'Casa Revuelta (cod fritters), La Casa del Abuelo (garlic prawns), Juana La Loca (elevated tapas — book), or Taberna La Concha (vermouth + tapas)', afternoon:'Wander La Latina, Plaza de la Paja and Cava Baja. Siesta/reset at apartment.', dinner:'Casa Lucio for classic Madrid or Sala de Despiece for something modern', cocktail:'Salmon Guru in Las Letras — creative, famous, book or arrive early', travelTime:'Walking + Metro', walkingRoute:'Moderate', estCost:'$220', booking:'Royal Palace — yes; Juana La Loca / Casa Lucio — recommended; Salmon Guru — yes', photoSpots:'Palacio Real courtyard, Mercado de San Miguel, La Latina rooftops', notes:'Do rooftops before dinner, not after. Templo de Debod again if you missed it yesterday.'},
  {date:'Mon 29 Mar', city:'madrid', title:'Toledo day trip', breakfast:'No', morning:'Train from Madrid Puerta de Atocha-Almudena Grandes to Toledo (~34 min). Arrive ~9:30am. Taxi to Mirador del Valle for the postcard view, then walk into the old town.', lunch:'Adolfo, La Orza, or Taberna El Botero in Toledo', afternoon:'Toledo Cathedral, Jewish Quarter, Synagogue of Santa María la Blanca, San Juan de los Reyes, Santo Tomé (El Greco). Return to Madrid ~5:30–7pm.', dinner:'Easy dinner in Barrio de las Letras', cocktail:'1862 Dry Bar (Malasaña) for classic cocktails, or Bad Company 1920 near Callao for speakeasy style', travelTime:'Renfe Avant train Madrid–Toledo return (~34 min each way)', walkingRoute:'Moderate', estCost:'$140', booking:'Book return Renfe train tickets ahead — yes', photoSpots:'Toledo skyline from Mirador del Valle, Cathedral interior', notes:'Toledo is hilly — wear proper shoes. First train from ~6:45am; easy day trip.'},
  {date:'Tue 30 Mar', city:'madrid', title:'Art, Salesas, Chueca + fine dining', breakfast:'No', morning:'Santa Eulalia Boulangerie or Acid Café for breakfast. Círculo de Bellas Artes rooftop for views. Prado Museum (€15pp, timed entry — book ahead).', lunch:'Murillo Café near Prado, La Castela (Retiro area), or TriCiclo in Las Letras', afternoon:'Retiro Park and Palacio de Cristal. Salesas for boutique shopping and stylish cafés. Chueca for a livelier local neighbourhood feel.', dinner:'DSTAgE — creative tasting menu (~€195pp), polished and memorable. Alternatives: Coque or DiverXO for full destination dining.', cocktail:'Pre-dinner drink at Círculo de Bellas Artes rooftop or Picalagartos', travelTime:'Walking', walkingRoute:'Moderate', estCost:'$260', booking:'DSTAgE reservation — book as soon as possible; Prado timed ticket — yes', photoSpots:'Palacio de Cristal in Retiro, Prado entrance, Salesas street scenes', notes:'Fine dining books out weeks ahead. One museum + wandering beats two museums.'},
  {date:'Wed 31 Mar', city:'madrid→valencia', title:'Arrival + Old Town evening', breakfast:'No', morning:'Check out Madrid, train to Valencia (~1hr 40min). Check in to Caro Hotel.', lunch:'Lunch en route or on arrival near hotel', afternoon:'Walk from Caro Hotel → Plaza de la Virgen → Valencia Cathedral → Plaza de la Reina → El Carmen lanes. Keep it atmospheric and easy.', dinner:'Casa Montaña for classic Valencian tapas & wine (book ahead) or John Ganissa for casual modern tapas in El Carmen', cocktail:'Café de las Horas — gorgeous theatrical old-world cocktail spot near the hotel. Very Valencia.', travelTime:'Train Madrid–Valencia AVE', walkingRoute:'Short', estCost:'$160', booking:'Casa Montaña — recommended; AVE train — yes', photoSpots:'Plaza de la Virgen, El Carmen laneways at dusk', notes:'Easy first night in Valencia — keep it walkable and low-key.'},
  {date:'Thu 1 Apr', city:'valencia', title:'Markets, paella + City of Arts', breakfast:'No', morning:'Coffee near hotel. Late morning: Mercado Central for food browsing and photos — try Central Bar by Ricard Camarena for a market breakfast if you can get seats. Then La Lonja de la Seda (UNESCO Silk Exchange, directly opposite the market — opens 10am–7pm Mon–Sat).', lunch:'Casa Carmela or La Pepica by the beach for proper Valencian paella. Casa Carmela is the more authentic choice — book well ahead.', afternoon:'Walk or taxi to City of Arts and Sciences for the architecture and photography moment. Evening: head to Ruzafa for a local neighbourhood feel.', dinner:'Taberna Pare Pere (casual, local, seafood/tapas) or La Cantina de Ruzafa (relaxed, great-value Valencian)', cocktail:'Café Madrid for classy cocktails or Ubik Café for casual neighbourhood vibes', travelTime:'Walking + taxi to City of Arts', walkingRoute:'Moderate', estCost:'$200', booking:'Casa Carmela paella lunch — book well ahead; La Lonja de la Seda — free entry, check hours', photoSpots:'Mercado Central interior, La Lonja columns, City of Arts reflections', notes:'Madrid eats late, but Valencia eats even later. Paella is traditionally a lunch dish here, not dinner.'},
  {date:'Fri 2 Apr', city:'valencia→mallorca', title:'Slow morning, then fly to Mallorca', breakfast:'No', morning:'Relaxed breakfast, then one final stroll: Jardín del Turia (green walk along the old riverbed) or Colón Market (lovely modernist building with cafés). Stop at Horchatería Santa Catalina for horchata + fartons, or Dulce de Leche Boutique for pastries. Check out and head to airport.', lunch:'Light lunch en route to Mallorca', afternoon:'Check in, explore Sóller & Port de Sóller, beach walk', dinner:'Seafood dinner, Sóller', cocktail:'Cocktails at sunset, Port de Sóller', travelTime:'Flight Valencia–Palma, then rental car pickup', walkingRoute:'Short', estCost:'$260', booking:'Flight — yes; rental car pickup — yes', photoSpots:'Jardín del Turia, Sóller wooden tram', notes:'Keep the morning slow — flight is the main event.'},
  {date:'Sat 3 Apr', city:'mallorca', title:'Sóller to Cala d\'Or & Cala Sa Nau', breakfast:'Yes (Alcázar Hotel Sóller)', morning:'8:30am leave Alcázar after breakfast. Drive southeast ~1hr 45min. 10:15am: S\'Amarador / Cala Mondragó — park near S\'Amarador, walk ~500m to beach. Turquoise water and white sand inside Mondragó Natural Park. Barefoot walk, photos, coffee, optional dip.', lunch:'1:00pm — Chiringuito Cala Sa Nau. Mediterranean food, fresh fish, cocktails on a sandy cove. Book ahead by phone/email; ask about sunbeds in early April.', afternoon:'3:00pm relax at Cala Sa Nau — beach time and drinks. 4:15pm: short wander around Cala d\'Or marina for ice cream or aperitif. 5:30pm drive back to Sóller.', dinner:'Easy dinner in Sóller or Port de Sóller', cocktail:'Relaxed evening back in Sóller', travelTime:'Self-drive — Sóller → Mondragó ~1hr 45min each way', walkingRoute:'Moderate', estCost:'$190', booking:'Chiringuito Cala Sa Nau lunch reservation — yes (phone/email)', photoSpots:'S\'Amarador turquoise water, Cala Sa Nau cove, Cala d\'Or marina', notes:'April water may be cool — plan for photos and a dip rather than a long swim. Confirm beach bar April trading when booking.'},
...
const FOOD = {
  madrid:{
    Breakfast:[
      {name:'Toma Café', cuisine:'Specialty coffee, relaxed', price:'$', mapsQuery:'Toma Cafe Madrid'},
      {name:'HanSo Café', cuisine:'Coffee, brunch, photogenic', price:'$', mapsQuery:'HanSo Cafe Madrid'},
      {name:'Santa Eulalia Boulangerie', cuisine:'Beautiful pastries, elegant', price:'$$', mapsQuery:'Santa Eulalia Boulangerie Madrid'},
      {name:'Acid Café', cuisine:'Design-led, excellent coffee', price:'$', mapsQuery:'Acid Cafe Madrid'},
      {name:'Federal Café', cuisine:'Easy brunch, reliable', price:'$', mapsQuery:'Federal Cafe Madrid'},
      {name:'La Mallorquina', cuisine:'Old-school pastry stop near Sol — touristy but iconic', price:'$', mapsQuery:'La Mallorquina Madrid'},
    ],
    Tapas:[
      {name:'Juana La Loca', cuisine:'Elevated tortilla & tapas', price:'$$', mapsQuery:'Juana La Loca Madrid', reservation:true},
      {name:'La Castela', cuisine:'Classic quality tapas, Retiro area', price:'$$', mapsQuery:'La Castela Madrid'},
      {name:'Casa Revuelta', cuisine:'No-frills cod fritters — Madrid institution', price:'$', mapsQuery:'Casa Revuelta Madrid'},
      {name:'Taberna La Concha', cuisine:'Vermouth & tapas, La Latina', price:'$', mapsQuery:'Taberna La Concha Madrid'},
      {name:'Sala de Despiece', cuisine:'Modern, fun, food-focused', price:'$$', mapsQuery:'Sala de Despiece Madrid'},
      {name:'Bodega de la Ardosa', cuisine:'Historic tavern — tortilla & vermouth', price:'$', mapsQuery:'Bodega de la Ardosa Madrid'},
      {name:'La Casa del Abuelo', cuisine:'Garlic prawns', price:'$$', mapsQuery:'La Casa del Abuelo Madrid'},
      {name:'Casa Lucio', cuisine:'Classic Madrid tapas', price:'$$$', mapsQuery:'Casa Lucio Madrid', reservation:true},
    ],
    'Rooftop Bars':[
      {name:'Riu 360', cuisine:'Best big skyline moment near Plaza de España', price:'$$$', mapsQuery:'Riu Plaza España 360 rooftop Madrid'},
      {name:'Ginkgo Sky Bar', cuisine:'Great for sunset, close to apartment', price:'$$$', mapsQuery:'Ginkgo Sky Bar Madrid'},
      {name:'Picalagartos', cuisine:'Central Gran Vía rooftop', price:'$$$', mapsQuery:'Picalagartos Sky Bar Madrid'},
      {name:'Casa Suecia', cuisine:'Stylish, good for cocktails', price:'$$$', mapsQuery:'Hotel Casa Suecia rooftop Madrid'},
      {name:'Círculo de Bellas Artes', cuisine:'Classic Madrid view — do before dinner', price:'$$', mapsQuery:'Circulo de Bellas Artes rooftop Madrid'},
      {name:'El Jardín de Diana', cuisine:'Pretty Gran Vía rooftop', price:'$$$', mapsQuery:'El Jardin de Diana rooftop Madrid'},
    ],
    'Cocktail Bars':[
      {name:'Salmon Guru', cuisine:'Creative, famous — book or arrive early', price:'$$$', mapsQuery:'Salmon Guru Madrid', reservation:true},
      {name:'1862 Dry Bar', cuisine:'Classic cocktails, Malasaña', price:'$$', mapsQuery:'1862 Dry Bar Madrid'},
      {name:'Bad Company 1920', cuisine:'Speakeasy / date-night feel near Callao', price:'$$$', mapsQuery:'Bad Company 1920 Madrid'},
      {name:'Viva Madrid', cuisine:'Beautiful old bar, great atmosphere', price:'$$', mapsQuery:'Viva Madrid bar'},
      {name:'Santos y Desamparados', cuisine:'Cool, less obvious choice', price:'$$', mapsQuery:'Santos y Desamparados Madrid'},
    ],
    'Fine Dining':[
      {name:'DSTAgE', cuisine:'Creative tasting menu ~€195 — top pick', price:'$$$$', mapsQuery:'DSTAgE Madrid', reservation:true},
      {name:'Coque', cuisine:'2-Michelin-star destination dining', price:'$$$$', mapsQuery:'Coque Madrid', reservation:true},
      {name:'DiverXO', cuisine:'3-Michelin-star, full destination dining', price:'$$$$', mapsQuery:'DiverXO Madrid', reservation:true},
    ],
    Markets:[
      {name:'Mercado de San Miguel', cuisine:'Glass-walled market — great for grazing & photos', price:'$$', mapsQuery:'Mercado de San Miguel Madrid'},
      {name:'Mercado de San Antón', cuisine:'Local food market, Chueca', price:'$$', mapsQuery:'Mercado de San Anton Madrid'},
    ],
    'Local Favourites':[
      {name:'La Latina tapas crawl — Cava Baja', cuisine:'Bar-hopping, lively and traditional', price:'$$', mapsQuery:'Cava Baja Madrid'},
      {name:'Salesas neighbourhood', cuisine:'Boutique shopping, galleries, stylish cafés', price:'$$', mapsQuery:'Barrio de las Salesas Madrid'},
      {name:'Malasaña wander', cuisine:'Bohemian, independent bars & shops', price:'$', mapsQuery:'Malasana Madrid'},
    ],
  },
  valencia:{
    Breakfast:[
      {name:'Horchatería Santa Catalina', cuisine:'Horchata & fartons — iconic Valencia stop', price:'$', mapsQuery:'Horchateria Santa Catalina Valencia'},
      {name:'Dulce de Leche Boutique', cuisine:'Pastries & coffee', price:'$', mapsQuery:'Dulce de Leche Valencia'},
      {name:'Central Bar by Ricard Camarena', cuisine:'Market breakfast/lunch at Mercado Central — arrive early for seats', price:'$$', mapsQuery:'Central Bar Mercado Central Valencia'},
    ],
    Tapas:[
      {name:'Casa Montaña', cuisine:'Classic Valencian tapas & wine — book ahead', price:'$$$', mapsQuery:'Casa Montana Valencia', reservation:true},
      {name:'John Ganissa', cuisine:'Casual modern Valencian tapas, El Carmen', price:'$$', mapsQuery:'John Ganissa Valencia'},
      {name:'Taberna Pare Pere', cuisine:'Casual, local, seafood & tapas feel, Ruzafa', price:'$$', mapsQuery:'Taberna Pare Pere Valencia'},
      {name:'La Cantina de Ruzafa', cuisine:'Relaxed, great-value Valencian, Ruzafa', price:'$$', mapsQuery:'La Cantina de Ruzafa Valencia'},
    ],
    'Paella & Rice':[
      {name:'Casa Carmela', cuisine:'Traditional wood-fired paella by the beach — top pick, book well ahead', price:'$$$', mapsQuery:'Casa Carmela Valencia', reservation:true},
      {name:'La Pepica', cuisine:'Classic beachside paella, Malvarrosa beach', price:'$$$', mapsQuery:'La Pepica Valencia', reservation:true},
    ],
    'Cocktail Bars':[
      {name:'Café de las Horas', cuisine:'Theatrical old-world cocktail spot near Caro Hotel — very Valencia', price:'$$', mapsQuery:'Cafe de las Horas Valencia'},
      {name:'Café Madrid', cuisine:'Classy cocktails', price:'$$$', mapsQuery:'Cafe Madrid Valencia'},
      {name:'Ubik Café', cuisine:'Casual neighbourhood vibes, Ruzafa', price:'$$', mapsQuery:'Ubik Cafe Valencia'},
    ],
    Markets:[
      {name:'Mercado Central', cuisine:'One of Europe\'s most beautiful food markets — go late morning for photos', price:'$', mapsQuery:'Mercado Central Valencia'},
      {name:'Colón Market', cuisine:'Lovely modernist building with cafés inside', price:'$$', mapsQuery:'Mercado Colon Valencia'},
    ],
    'Local Favourites':[
      {name:'El Carmen neighbourhood', cuisine:'Laneways, bars, street art — best for an evening wander', price:'$$', mapsQuery:'El Carmen Valencia'},
      {name:'Ruzafa neighbourhood', cuisine:'Local, creative, less touristy — best for dinner and drinks', price:'$$', mapsQuery:'Ruzafa Valencia'},
    ],
  },
  mallorca:{
...
const EXPERIENCES = [
  ...
  {city:'madrid', title:'Eco Tuk Tuk Express City Tour', tag:'Tour', desc:'1-hour private city tour by electric tuk tuk. Booked — Sun 28 Mar at 10:00am, 2 adults. A$130.38 paid. Free cancellation until 9:00am on 27 Mar. Rated 4.8/5 (3,843 reviews).', mapsQuery:'Eco Tuk Tuk Madrid'},
  {city:'madrid', title:'Templo de Debod at sunset', tag:'Sunset', desc:'Ancient Egyptian temple with unbeatable Madrid sunset views. Free entry, walk from Gran Vía. Best 30–45 min before sunset.', mapsQuery:'Templo de Debod Madrid'},
  {city:'madrid', title:'Toledo day trip', tag:'Day trip', desc:'UNESCO old town, 34 min by Renfe Avant from Atocha. Taxi first to Mirador del Valle for the view, then old town: Cathedral, Jewish Quarter, San Juan de los Reyes, Santo Tomé (El Greco). Lunch at Adolfo or La Orza. Book return trains ahead.', mapsQuery:'Toledo Spain'},
  {city:'madrid', title:'Retiro Park & Palacio de Cristal', tag:'Parks', desc:'Enormous city park — great for a slow afternoon walk. The Palacio de Cristal (glass palace) is the highlight: free, beautiful, always has an installation inside.', mapsQuery:'Retiro Park Madrid'},
  {city:'madrid', title:'Salesas neighbourhood', tag:'Shopping', desc:'Best boutique shopping in Madrid. Independent stores, galleries, stylish cafés. More interesting than Gran Vía\'s high street.', mapsQuery:'Barrio de las Salesas Madrid'},
  {city:'madrid', title:'Royal Palace exterior + Plaza de Oriente', tag:'Architecture', desc:'Even if you skip the interior, the exterior and Plaza de Oriente are worth the walk. Interior €24pp — book ahead if you want it.', mapsQuery:'Palacio Real Madrid'},
  {city:'madrid', title:'Círculo de Bellas Artes rooftop', tag:'Rooftop', desc:'Best classic Madrid rooftop view over Gran Vía. Go before dinner, not after. Small entry fee.', mapsQuery:'Circulo de Bellas Artes Madrid'},
  {city:'madrid', title:'La Latina tapas crawl — Cava Baja', tag:'Food & drink', desc:'The classic Madrid bar-hop. Wander Cava Baja and surrounding streets — drop in anywhere that looks busy. Best on a Sunday lunchtime or weekend evening.', mapsQuery:'Cava Baja Madrid'},
  {city:'madrid', title:'Mercado de San Miguel', tag:'Markets', desc:'Glass-walled market near Plaza Mayor. Best for photos and grazing snacks — not a sit-down meal. Go mid-morning or early afternoon.', mapsQuery:'Mercado de San Miguel Madrid'},
  {city:'madrid', title:'Museo del Prado', tag:'Museums', desc:'World-class art museum — Velázquez, Goya, El Greco. €15pp, timed entry required. Book online ahead. Allow 2–3 hours minimum.', mapsQuery:'Museo del Prado Madrid'},
  {city:'madrid', title:'DSTAgE fine dining', tag:'Fine dining', desc:'Top pick for the Madrid fine dining night. Creative, polished, memorable — tasting menu ~€195pp. Book as far ahead as possible.', mapsQuery:'DSTAgE Madrid'},
  {city:'valencia', title:'Mercado Central', tag:'Markets', desc:'One of Europe\'s most beautiful food markets. Go late morning for photos and grab a seat at Central Bar by Ricard Camarena if you can.', mapsQuery:'Mercado Central Valencia'},
  {city:'valencia', title:'La Lonja de la Seda', tag:'Architecture', desc:'UNESCO Silk Exchange directly opposite the Mercado Central. Free entry, opens 10am–7pm Mon–Sat. One of Valencia\'s must-sees.', mapsQuery:'La Lonja de la Seda Valencia'},
  {city:'valencia', title:'City of Arts and Sciences', tag:'Architecture', desc:'Futurist complex by Calatrava — great for photography, especially the reflections. Easy to enjoy from outside. Science Museum open roughly 10am–7pm low season.', mapsQuery:'Ciudad de las Artes y las Ciencias Valencia'},
  {city:'valencia', title:'Jardín del Turia', tag:'Walking', desc:'Former riverbed turned 9km green park running through the city. Great for a slow morning stroll before leaving for Mallorca.', mapsQuery:'Jardin del Turia Valencia'},
  {city:'valencia', title:'El Carmen neighbourhood', tag:'Neighbourhood', desc:'Laneways, street art, bars and the cathedral quarter. Best explored on foot in the evening.', mapsQuery:'El Carmen Valencia'},
  {city:'valencia', title:'Ruzafa neighbourhood', tag:'Neighbourhood', desc:'Valencia\'s most local, creative district. Best for dinner and after-dinner drinks — more authentic than the tourist centre.', mapsQuery:'Ruzafa Valencia'},
  {city:'valencia', title:'Café de las Horas cocktails', tag:'Cocktail bar', desc:'Theatrical, gorgeous old-world cocktail bar near the Caro Hotel. One of the most atmospheric spots in Valencia — go after dinner on arrival night.', mapsQuery:'Cafe de las Horas Valencia'},
...
const TRACKER_DEFAULTS = [
  ...
  {id:'rest-vlc-montana',  group:'Restaurant Bookings', label:'Valencia — Casa Montaña tapas (Wed 31 Mar)',         done:false, note:'Classic Valencian tapas & wine — book ahead'},
  {id:'rest-vlc-carmela',  group:'Restaurant Bookings', label:'Valencia — Casa Carmela paella (Thu 1 Apr)',          done:false, note:'Traditional wood-fired paella — book well ahead'},
  ...
  // Attractions
  {id:'attr-tuktuk', group:'Attractions', label:'Madrid — Eco Tuk Tuk Express City Tour (Sun 28 Mar)', done:true, note:'Booked · 10:00am · 2 adults · A$130.38 · free cancellation until 9:00am 27 Mar'},
