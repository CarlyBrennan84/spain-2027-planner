...
const DAYS = [
  {date:'Sat 27 Mar', city:'madrid', title:'Arrival — easy first night', breakfast:'—', morning:'Overnight flight from Melbourne (departed 22:35 Fri) lands 16:25 — settle into the Gran Vía Airbnb, unpack, freshen up. Expect to be tired after 27h 50m in transit.', lunch:'—', afternoon:'Short walk around Gran Vía to get oriented.', cocktail:'Salmon Guru or a nearby vermouth bar', dinner:'Casual tapas near the apartment — no reservations, just wander', walkingRoute:'Gran Vía → Plaza de España loop', estCost:'$80–110', travelTime:'Airport → Gran Vía: ~35 min taxi', booking:'Airport transfer (optional)', photoSpots:'Gran Vía at dusk, Metropolis Building', notes:''},
  {date:'Sun 28 Mar', city:'madrid', title:'Architecture & markets', breakfast:'Coffee + churros near the apartment', morning:'Palacio Real and Almudena Cathedral', lunch:'Mercado de San Miguel — graze the stalls', afternoon:'Retiro Park, Puerta de Alcalá', cocktail:'Rooftop at Círculo de Bellas Artes (Azotea)', dinner:'Traditional tapas crawl, La Latina', walkingRoute:'Palacio Real → Mercado San Miguel → La Latina → Retiro', estCost:'$120–160 pp', travelTime:'Mostly walkable, ~25 min total transit', booking:'Palacio Real timed entry recommended', photoSpots:'Palacio Real courtyard, Retiro glass palace', notes:''},
  {date:'Mon 29 Mar', city:'madrid', title:'Toledo day trip', breakfast:'Early coffee before the train', morning:'Train to Toledo (~30 min high-speed), walk the old town walls', lunch:'Local restaurant in Toledo — try carcamusas', afternoon:'Toledo Cathedral, Alcázar viewpoint, artisan sword shops', cocktail:'Back in Madrid — Malasaña wine bar', dinner:'Malasaña neighbourhood, casual', walkingRoute:'Toledo old town loop from station', estCost:'$140–180 pp incl. train', travelTime:'Madrid–Toledo train: ~33 min each way', booking:'Book Toledo train tickets ahead (Renfe)', photoSpots:'Toledo skyline from Mirador del Valle', notes:''},
  {date:'Tue 30 Mar', city:'madrid', title:'Art & rooftops', breakfast:'Café near Prado', morning:'Museo del Prado or Reina Sofía', lunch:'Nearby tapas bar, Barrio de las Letras', afternoon:'Barrio de las Letras wander, small galleries and bookshops', cocktail:'The Roof at Hotel Ilunion or Picalagartos', dinner:'Wine and jamón in Chueca', walkingRoute:'Prado → Barrio de las Letras → Chueca', estCost:'$130–170 pp', travelTime:'Walkable', booking:'Museum tickets ahead', photoSpots:'Barrio de las Letras literary quotes on pavement', notes:''},
  {date:'Wed 31 Mar', city:'madrid→valencia', title:'Travel day — on to Valencia', breakfast:'Quick coffee before checkout', morning:'Check out, high-speed train Madrid → Valencia', lunch:'Arrive Valencia, lunch near Caro Hotel, Old Town', afternoon:'Check in at Caro Hotel, wander Barrio del Carmen', cocktail:'Old Town cocktail bar', dinner:'First paella night', walkingRoute:'Estació del Nord → Barrio del Carmen', estCost:'$150–200 pp incl. train', travelTime:'Madrid–Valencia AVE: ~1h40', booking:'Book AVE train tickets ahead', photoSpots:'Torres de Serranos at golden hour', notes:''},
  {date:'Thu 1 Apr', city:'valencia', title:'Old town & markets', breakfast:'Horchata and fartons', morning:'Mercado Central, Lonja de la Seda', lunch:'Paella lunch (traditional time, ~2pm) near the market', afternoon:'City of Arts and Sciences, or a stroll through Turia Gardens', cocktail:'Rooftop or old town cocktail bar', dinner:'Fine dining in Barrio del Carmen', walkingRoute:'Mercado Central → Lonja → Turia Gardens → Ciudad de las Artes', estCost:'$140–190 pp', travelTime:'Walkable / short tram to City of Arts & Sciences', booking:'Paella lunch reservation recommended', photoSpots:'City of Arts and Sciences reflections', notes:''},
  {date:'Fri 2 Apr', city:'valencia→mallorca', title:'Travel day — fly to Mallorca', breakfast:'Hotel breakfast or café before flight', morning:'Check out, flight Valencia → Palma de Mallorca', lunch:'Arrive Palma, lunch in Santa Catalina', afternoon:'Transfer to Sóller (train or car), check in to Alcázar Hotel Sóller', cocktail:'Sóller old town café-bar', dinner:'Local Mallorcan restaurant, Sóller', walkingRoute:'Palma airport → Sóller (scenic train option)', estCost:'$180–240 pp incl. flight', travelTime:'Flight ~45 min; Palma–Sóller ~40 min', booking:'Flight + car hire pickup', photoSpots:'Sóller wooden tram, Plaça de la Constitució', notes:''},
  {date:'Sat 3 Apr', city:'mallorca', title:'Coastal drive & coves', breakfast:'Included at hotel', morning:'Scenic drive along the Tramuntana coast to Deià', lunch:'Cafe in Deià with sea views', afternoon:'Hidden coves — Cala Deià or Sa Calobra (weather permitting)', cocktail:'Sunset drinks, Port de Sóller', dinner:'Seafood, Port de Sóller marina', walkingRoute:'Sóller → Deià → Port de Sóller loop', estCost:'$120–160 pp', travelTime:'Car hire, ~1.5–2h scenic driving', booking:'Car hire pickup confirmed', photoSpots:'Cala Deià cliffs, Tramuntana mountain road', notes:''},
  {date:'Sun 4 Apr', city:'mallorca', title:'Boat trip & wineries', breakfast:'Included at hotel', morning:'Boat trip along the northwest coast', lunch:'On the boat or back in Port de Sóller', afternoon:'Wine tasting at a Mallorcan winery inland', cocktail:'Winery terrace or Sóller square', dinner:'Boutique restaurant, Sóller', walkingRoute:'Port de Sóller → inland wine region', estCost:'$160–220 pp incl. boat & tasting', travelTime:'Boat ~2–3h; drive to winery ~30 min', booking:'Boat trip + winery tasting to book ahead', photoSpots:'Coastline from the water, vineyard rows', notes:''},
  {date:'Mon 5 Apr', city:'mallorca', title:'Mountain villages', breakfast:'Included at hotel', morning:'Drive to Fornalutx — one of Spain\'s prettiest villages', lunch:'Village café, Fornalutx or Biniaraix', afternoon:'Slow photography walk, mountain village lanes', cocktail:'Sóller square, last evening in Mallorca', dinner:'Farewell Mallorca dinner, Sóller', walkingRoute:'Sóller → Fornalutx → Biniaraix', estCost:'$100–140 pp', travelTime:'Short drives, ~20 min each', booking:'—', photoSpots:'Fornalutx stone lanes and orange trees', notes:''},
  {date:'Tue 6 Apr', city:'mallorca→barcelona', title:'Travel day — on to Barcelona', breakfast:'Included at hotel before departure', morning:'Return car hire, transfer to Palma airport', lunch:'Airport or arrival lunch in Barcelona', afternoon:'Flight Palma → Barcelona, check into Airbnb', cocktail:'Welcome drink, El Born or Gothic Quarter', dinner:'Tapas in the Gothic Quarter', walkingRoute:'Airbnb → Gothic Quarter orientation walk', estCost:'$150–200 pp incl. flight', travelTime:'Flight ~50 min', booking:'Car hire drop-off, flight', photoSpots:'Gothic Quarter laneways at dusk', notes:''},
  {date:'Wed 7 Apr', city:'barcelona', title:'Gothic Quarter & architecture', breakfast:'Coffee in El Born', morning:'Gothic Quarter, Barcelona Cathedral', lunch:'Tapas, El Born', afternoon:'Sagrada Família or Park Güell', cocktail:'Rooftop bar with Sagrada Família views', dinner:'Tapas crawl, Gothic Quarter', walkingRoute:'Gothic Quarter → El Born → Sagrada Família', estCost:'$150–200 pp', travelTime:'Metro to Sagrada Família ~15 min', booking:'Sagrada Família timed entry — book ahead', photoSpots:'Sagrada Família towers, Park Güell mosaic terrace', notes:''},
  {date:'Thu 8 Apr', city:'barcelona', title:'Final luxury day', breakfast:'Café, Passeig de Gràcia', morning:'Casa Batlló / Casa Milà exteriors, Passeig de Gràcia', lunch:'Market lunch, La Boqueria', afternoon:'Beach walk, Barceloneta, or last souvenir shopping', cocktail:'Sunset rooftop, final cocktails', dinner:'Final luxury dinner — book a special table', walkingRoute:'Passeig de Gràcia → La Boqueria → Barceloneta', estCost:'$200–280 pp — final dinner splurge', travelTime:'Walkable / short metro hops', booking:'Final dinner reservation essential', photoSpots:'Casa Batlló façade, Barceloneta sunset', notes:''},
  {date:'Fri 9 Apr', city:'barcelona', title:'Flight home', breakfast:'Early coffee before departure', morning:'Flight home departs 07:35 — transfer to airport very early. 28h 5m to Melbourne, arriving 20:40 Sat 10 Apr.', lunch:'—', afternoon:'—', cocktail:'—', dinner:'—', walkingRoute:'—', estCost:'Airport transfer', travelTime:'Book transfer for ~5:00am pickup', booking:'Airport transfer', photoSpots:'—', notes:''},
];
...
function renderBudget(){
  ...
  const rows = STATE.budget.map((b,i)=>{
    const bal = Number(b.est||0) - Number(b.actual||0);
    return `
